...
class TokenPrinter(object):
    ...
    def stringliteral(self, value):
        ...
        # Prefer ASCII-only string literals for stability across output encodings.
        # This avoids UnicodeEncodeError in narrow terminal encodings and preserves
        # escaped-literal intent for non-Latin text.
        s = ascii(value) if any(ord(ch) > 127 for ch in value) else repr(value)
